...
public class UpdateUserByPutTest {
    ...
    public void updateAge() throws IOException {
        ...
        assertAll(
                ...
                () -> assertEquals(200, updateUser.getStatusCode(), "Status code is incorrect: " + updateUser.getStatusCode()),
                () -> assertEquals("{}", updateUser.getBody(), "The response body is incorrect: " + updateUser.getBody()),
                () -> assertEquals("[{\"name\":\"Tester25\",\"age\":26,\"sex\":\"MALE\"}]", getUsers.getBody(), "The body is incorrect. Get users: " + getUsers.getBody())
        );
    }
    ...
    public void updateName() throws IOException {
        ...
        assertAll(
                ...
                () -> assertEquals(200, updateUser.getStatusCode(), "Status code is incorrect: " + updateUser.getStatusCode()),
                () -> assertEquals("{}", updateUser.getBody(), "The response body is incorrect: " + updateUser.getBody()),
                () -> assertEquals("[{\"name\":\"Tester26\",\"sex\":\"MALE\"}]", getUsers.getBody(), "The body is incorrect. Get users: " + getUsers.getBody())
        );
    }
    //age and zip code are missed
    @Test
    public void updateSex() throws IOException {
        ...
        assertAll(
                ...
                () -> assertEquals(200, updateUser.getStatusCode(), "Status code is incorrect: " + updateUser.getStatusCode()),
                () -> assertEquals("{}", updateUser.getBody(), "The response body is incorrect: " + updateUser.getBody()),
                () -> assertEquals("[{\"name\":\"Tester25\",\"sex\":\"FEMALE\"}]", getUsers.getBody(), "The body is incorrect. Get users: " + getUsers.getBody())
        );
    }
    //age is missed
    @Test
    public void updateZipCode() throws IOException {
        ...
        assertAll(
                ...
                () -> assertEquals(200, updateUser.getStatusCode(), "Status code is incorrect: " + updateUser.getStatusCode()),
                () -> assertEquals("{}", updateUser.getBody(), "The response body is incorrect: " + updateUser.getBody()),
                () -> assertEquals("[{\"name\":\"Tester25\",\"sex\":\"MALE\",\"zipCode\":\"12345\"}]", getUsers.getBody(), "The body is incorrect. Get users: " + getUsers.getBody())
        );
    }
