...
public class ApacheClient implements ClientInterface {
    ...
    protected static final Logger logger = LoggerFactory.getLogger(ApacheClient.class);
    ...
    public static synchronized ApacheClient getInstance() {
        if (instance == null) {
